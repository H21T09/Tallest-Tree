...
public class RewardedAdsButton : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    _adUnitId = _iOSAdUnitId;
        ...
        // Load quảng cáo ngay khi game bắt đầu
        LoadAd();
    }
    ...
    public void OnUnityAdsShowComplete(string adUnitId, UnityAdsShowCompletionState showCompletionState)
    {
        if (adUnitId.Equals(_adUnitId) && showCompletionState == UnityAdsShowCompletionState.COMPLETED)
        {
            ...
            SeedManager.Instance.AddSeed(rewardAmount);

            Debug.Log("Rewarded: " + rewardAmount + " seeds!");

            // Load quảng cáo tiếp theo sau khi xem xong
            LoadAd();
        }
    }
